                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                WatchIt has wonderful, thorough documentation covering every aspect of the framework.
                                Whether you are new to the framework or have previous experience with WatchIt, we
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                    class="underline text-gray-900 dark:text-white">WatchItAlbum</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                WatchItAlbum offers thousands of video tutorials on WatchIt, PHP, and JavaScript
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href=""
                                    class="underline text-gray-900 dark:text-white">WatchIt News</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                WatchIt News is a community driven portal and newsletter aggregating all of the latest
                                and most important news in the WatchIt ecosystem, including new package releases and
                                tutorials.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                WatchIt's robust library of first-party tools and libraries, such as <a href=""
                                    class="underline">Forge</a>, <a href="" class="underline">Vapor</a>, <a href=""
